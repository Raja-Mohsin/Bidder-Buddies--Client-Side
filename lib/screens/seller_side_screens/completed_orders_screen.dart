      ...
      builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            String date = completedOrders[index].date.toString();
            ...
            return GestureDetector(
              onTap: () {
                ...
                //   MaterialPageRoute(
                //     builder: (context) =>
                //         OrderTimelineScreen(completedOrders[index].id),
                //   ),
                // );
              },
              child: Container(
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Image.network(
                                completedOrders[index].imageUrl,
                                width: 70,
                                height: 70,
                              ),
                            ),
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'Rs. ${completedOrders[index].price}',
